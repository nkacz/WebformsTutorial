...
public class NVPAPICaller
{
    ...
    public string APIUsername = "nickkaczmarek-facilitator_api1.me.com";
    private string APIPassword = "V5MHUXNJ9PUQMSYD";
    private string APISignature = "ArNS7dGQu3ShnzihRhER.04AQZlsAaVhMMSoqWjBue-qE1xMkeo8iY6P";
